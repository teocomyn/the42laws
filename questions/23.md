...
## Prolongement : l’IA entre les lois et leurs conséquences

**Analyse de portée.** Découvrir une nouvelle propriété d’une équation et découvrir une nouvelle loi physique sont deux opérations différentes. Une démonstration peut préciser ce qu’autorise un modèle déjà connu sans apporter de nouvelle observation sur l’Univers. De même, obtenir un résultat particulier ne donne pas une méthode permettant de calculer toutes les conséquences du modèle.

L’annonce Navier–Stokes de septembre 2026 concerne un cadre avec force extérieure lisse [S335]. Il faut garder ce paramètre visible avant toute extrapolation vers un fluide sans forçage ou vers l’unification des interactions. Le communiqué du Clay Institute du 11 septembre parle d’une résolution apparente et d’un processus d’évaluation ; nous n’avons pas audité la démonstration [S334].

**Question à conserver dans le carnet :** qu’ai-je appris — une propriété mathématique, une prédiction testable ou une nouvelle loi ? Décrire le passage de l’un à l’autre oblige à expliciter les hypothèses. Prolongement : [dix idées sur l’IA et la connaissance, dossier 41](41.md).
