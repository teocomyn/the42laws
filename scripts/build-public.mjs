...
export async function buildPublic(siteURL=process.env.SITE_URL||''){
 ...
 await writeFile(resolve(out,'404.html'),'<!doctype html><html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>Page introuvable — The42laws</title><link rel="icon" href="/favicon.ico" sizes="16x16 32x32 48x48"><link rel="icon" type="image/png" sizes="48x48" href="/atlas/favicon-42-48.png"><link rel="icon" type="image/png" sizes="32x32" href="/atlas/favicon-42-32.png"><link rel="apple-touch-icon" sizes="180x180" href="/atlas/favicon-42-180.png"></head><body><h1>Reprenons le fil.</h1><p>Cette page n’existe pas.</p><a href="'+esc(base||'/')+'">Retour à l’atlas</a></body></html>');
